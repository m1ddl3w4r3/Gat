...
depends:
	openssl req -subj '/CN=ace.com/O=ACE/C=FR' -new -newkey rsa:4096 -days 3650 -nodes -x509 -keyout ${SRV_KEY} -out ${SRV_PEM}
	cat ${SRV_KEY} >> ${SRV_PEM}
...
clean:
	rm -rf ${SRV_KEY} ${SRV_PEM} Agents/ meterpreter/Gat.rc
